...
function initializeRoutes() {
  ...
  // P3 Starter Kit - Redirect to GitHub (zip download deprecated)
  app.get('/api/sdk/download', (_req: Request, res: Response) => {
    res.redirect('https://github.com/archi-tect0/P3-Protocol');
  });
